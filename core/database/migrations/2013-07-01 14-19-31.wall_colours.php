...
class build_wall_colours extends base_build
{
    private $_builder;
    ...
    public function __Construct ( $db_name, $tablename )
    {
        ...
        $this->_build = new query_builder ( $db_name, "wall_colours" );
    }

    public function put ()
    {
        $this->_build->create_table ( "wall_colours" );
    ...
    {
        $table_exists = mysql_query ( "SHOW TABLES LIKE 'cosmos_wall_colours'" );
...
$build = new build_wall_colours ( $this->_db_name, "wall_colours" );
$build->desc ();
