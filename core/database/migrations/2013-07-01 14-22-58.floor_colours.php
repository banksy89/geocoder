...
class build_floor_colours extends base_build
{
    private $_builder;
    ...
    public function __Construct ( $db_name, $tablename )
    {
        ...
        $this->_build = new query_builder ( $db_name, "floor_colours" );
    }

    public function put ()
    {
        $this->_build->create_table ( "floor_colours" );
    ...
    {
        $table_exists = mysql_query ( "SHOW TABLES LIKE 'cosmos_floor_colours'" );
...
$build = new build_floor_colours ( $this->_db_name, "floor_colours" );
$build->desc ();
